...
public class NuevoPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonPost = (Button)findViewById(R.id.botonPostear);
    ...
    private void crearNuevoPost(double lat, double lon)
    {
        ...
        Post nuevoPost = new Post(LoginActivity.getUsuarioNuevo(),imagen,tituloString,cuerpoString,lat,lon);
